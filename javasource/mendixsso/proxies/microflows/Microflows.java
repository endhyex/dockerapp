...
public final class Microflows
{
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder getDefaultSignupHintBuilder()
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("MendixSSO.GetDefaultSignupHint");
		return builder;
	}

	public static java.lang.String getDefaultSignupHint(IContext context)
	{
		Object result = getDefaultSignupHintBuilder().execute(context);
		return (java.lang.String) result;
	}
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder mendixSSO_ParseSignupHintBuilder(
		system.proxies.HttpRequest _httpRequest
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("MendixSSO.MendixSSO_ParseSignupHint");
		builder = builder.withParam("HttpRequest", _httpRequest);
		return builder;
	}

	public static java.lang.String mendixSSO_ParseSignupHint(
		IContext context,
		system.proxies.HttpRequest _httpRequest
	)
	{
		Object result = mendixSSO_ParseSignupHintBuilder(
				_httpRequest
			)
			.execute(context);
		return (java.lang.String) result;
