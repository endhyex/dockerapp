...
export default {
    ...
    plugins: [
        mendixResolve(
            ...
            "C:/Users/TIENDHIKA LESMANA/Mendix/DockerApp/deployment/web/cachetag.txt"
        ),
        nodePolyfills(),
        esbuild({
            sourceMap: shouldGenerateSourceMaps,
        ...
        generatePrecacheServiceWorker({
            deploymentDir: "C:/Users/TIENDHIKA LESMANA/Mendix/DockerApp/deployment",
        }),
        mendixCopy({
            targetFolder: "dist",
            sources: [
                {
                    folder: "C:/Users/TIENDHIKA LESMANA/Mendix/DockerApp/deployment/web/widgets",
                    exclude: [".js", ".mjs", ".css"],
                    include: "**",
                },
            ],
